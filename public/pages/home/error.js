export function errorDictionary(error) {
    ...
    this.storageErrorCode = {
        ...
        "storage/retry-limit-exceeded": "O limite máximo de tempo da operação foi excedido. Envie novamente.",
    ...
    this.firestoreErrorCode = {
        ...
        "firestore/invalid-argument": "argumento inválido: o cliente especificou um argumento inválido.",
        "firestore/deadline-exceeded": "prazo excedido: o prazo expirou antes que a operação pudesse ser concluída.",
